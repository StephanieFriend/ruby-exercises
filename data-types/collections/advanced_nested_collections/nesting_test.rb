...
class NestedTest < MiniTest::Test
  ...
  def test_full_menu_for_olive_garden
    #=======================
     olive_garden_menu = {"Risotto" => stores[:olive_garden][:dishes][0], "Steak" => stores[:olive_garden][:dishes][1]}
    #=======================
  ...
  def test_menu_accross_all_restaurants
    #=======================
      full_menu = {"Risotto" => stores[:olive_garden][:dishes][0],
                   "Steak" => stores[:olive_garden][:dishes][1],
                   "Pancakes" => stores[:dennys][:dishes][0],
                   "Waffles" => stores[:dennys][:dishes][1],
                   "Big Mac" => stores[:macdonalds][:dishes][0],
                   "Fries" => stores[:macdonalds][:dishes][1]}
    #=======================
    expected = ({"Risotto"=>
