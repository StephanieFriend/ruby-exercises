...
class RejectPatternTest < Minitest::Test
  ...
  def test_remove_vowels
    ...
    letters.each do |letter|
      remaining << letter unless ([letter] - vowels).empty?
    end
  ...
  def test_remove_words_ending_in_e
    ...
    selected = []
    words.each do |word|
      selected << word unless word[-1, 1] == "e"
    end
  ...
  def test_remove_words_ending_in_ing
    ...
    selected = []
    words.each do |word|
      selected << word unless word[-3, 3] == "ing"
    end
  ...
  def test_remove_dinosaurs
    ...
    animals.each do |animal|
      notasaurus << animal unless animal[-6, 6] == "saurus"
    end
  ...
  def test_remove_animals_starting_with_vowels
    ...
    vowels = ["a", "e", "i", "o", "u"]
    animals.each do |animal|
      remaining << animal unless ([animal[0, 1]] - vowels).empty?
    end
